 ...
 */
class CacheProvider implements \SFM_MonitorableInterface, \SFM_Transaction_Engine
{
    const KEY_DELIMITER = '@';
    ...
    /**
     * @var \SFM\Cache\Transaction\TransactionCache
     */
    ...
    /**
     * @var \SFM\Cache\Generator\GeneratorInterface
     */
    protected $generator;

    /**
     * @var \SFM\Cache\Packer\PackerInterface
     */
    protected $packer;
     ...
     */
    public function set(\SFM_Business $business)
    {
